...
import React__default, { useLayoutEffect, forwardRef, useContext, createElement, createContext, Fragment, useRef, Children, isValidElement, cloneElement } from 'react';
...
var Button$1 = function (_a) {
    ...
    return (React__default.createElement("button", { type: "button", 
        // className={classNames(
        //   'storybook-button',
        //   `storybook-button--${size}`,
        //   `storybook-button--${type}`
        // )}
        style: textColor ? { color: textColor } : {}, onClick: onClick }, label));
};
...
var MatButton = function (_a) {
    var label = _a.label, rest = __rest(_a, ["label"]);
    return React__default.createElement(MuiButton, __assign({}, rest), label);
};
MatButton.defaultProps = { variant: 'outlined' };

export { Button$1 as Button, MatButton };
